...
const SERVICES = [
  {
    ...
    desc: "Custom websites built for performance, clarity, and conversion. From landing pages to full multi-page systems.",
    tag: "WEB",
  },
  {
    n: "02",
    title: "Software & Product Development",
    desc: "Custom dashboards, internal tools, booking systems, portals — built with React, Node and modern tooling.",
    tag: "SOFTWARE",
  },
  {
    n: "03",
    title: "Digital Marketing & Creatives",
    desc: "Social media posters, ad creatives, brand graphics and campaign assets that actually move the needle.",
    tag: "MARKETING",
  },
  {
    n: "04",
